...
RECT g_WindowRect; // stores previous window size when entering fullscreen
...
{
    // Retrieves the width and height of the primary display
    ...
    _In_ int nCmdShow)
{
    ...
    {
        std::shared_ptr<Tutorial2> demo = std::make_shared<Tutorial2>(L"Learning DirectX12 - Lesson 2", 1280, 720);
